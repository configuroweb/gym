...
if($res){
	...
	echo "<tr>
		...
		<td height='35'>&nbsp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;<input id='boxx' type='text' value='S/.".$row['amount']."' readonly></td></tr>
		<tr>
